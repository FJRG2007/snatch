...
def main(email_or_username, name, first, last, birthdate, addinfo, username, company, providers, saveonfile, validate, list):
    if email_or_username == None or re.match(r'^[\w\.-]+@[a-zA-Z\d\.-]+\.[a-zA-Z]{2,}$', email_or_username): search_email(email_or_username, name, first, last, birthdate, addinfo, username, company, providers, saveonfile, validate, list)
